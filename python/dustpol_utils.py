...
def show_vectors(image, pola, poli=None, step=1, scale=1, rotate=0, mask=None, color='lime', ax=None, lw=1):
    ...
    lc = mc.LineCollection(linelist, color=color, linewidths=lw)
    if ax is None:
        fig, ax = plt.subplots()
